...
def canton_list(request: HttpRequest) -> HttpResponse:
    ...
    return render(request, "geo/canton_list.html", {
        'cantons': Kanton.objects.all(),
    })
...
def canton_detail(request: HttpRequest, canton_id: int) -> HttpResponse:
    ...
    return render(request, "geo/canton_detail.html", {
        'canton': canton,
    })
...
def commune_detail(request: HttpRequest, commune_id: int) -> HttpResponse:
    ...
    return render(request, "geo/commune_detail.html", {
        'commune': commune,
    })
